...
if __name__ == '__main__':
    ...
    log_file_name = r'D:\PycharmProjects\KeywordExtraction\data\patent_abstract\6种专利摘要各100条已标注\bingxiang_RAKE_TFIDF_textRank_ours_techField_wordAVG_1.04_50_NEW.txt'
