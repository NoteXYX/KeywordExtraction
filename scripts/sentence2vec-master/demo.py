...
sent_file = r'D:\PycharmProjects\Dataset\keywordEX\patent\bxk_fc_rm_abstract.txt'
model = Sent2Vec(LineSentence(sent_file), model_file=r'D:\PycharmProjects\Dataset\keywordEX\patent\word2vec\all_rm_abstract_200_mincount1.model')
model.save_sent2vec_format(r'D:\PycharmProjects\Dataset\keywordEX\patent\sent2vec\bxk_fc_rm_techField_200.vec')
